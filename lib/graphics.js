...
class Graphics{
     ...
     * @param {Color} color
     */
    constructor( container = null , fps = 30 , color = '') {

        this._renderer = Renderer.create( container );
        this._fps = fps || 30;
        this._grid = 0;
        this._baseColor = color || Graphics.Color.White;
    }
    /**
     * @returns {Number}
     */
     ...
     * @returns {Graphics}
     */
    draw(image, source, destination, opacity = 1, mode = '', color = Graphics.Color.White ){
    ...
    drawImage( image ,x = 0, y= 0){
        this.renderer().renderImage( image , x , y);
        return this;
    }
    /**
     * @returns {Graphics}
   ...
   /**
     ...
     */
    clear(){
        this.renderer().clear(this._baseColor);
    }
}
...
class Renderer{
    ...
    initialize(){
        this._scale = 1;
        this._color = Graphics.Color.White;
     ...
     * @returns {Renderer}
     */
    renderContent( image , source , destination ){
    ...
    renderImage( image , x = 0 , y = 0){
        this.display().drawImage( image, x , y);
        return this;
    }
    /**
     * 
     ...
     */
    blendImage(image, area, color = Graphics.Color.White ){
     ...
     * @returns {Renderer}
     */
    setColor( color = Graphics.Color.White ){
        this._color = color;
        return this;
    }
    /**
     ...
     * @returns {Renderer}
     */
    setStroke( style = Graphics.Color.White ){
     ...
     */
    fillContent( color = '' ){
        this.display().fillStyle = color ||  Graphics.Color.White;
        return this;
    }
    /**
     * @param {Area} area 
