...
class SpriteState{
    ...
    move( sprite = null){
        if( sprite instanceof Sprite ){
            //update here all sprite/entity instance properties (position, collission etc)
            if( this.speed().moving()){
                sprite.move(this.speed());
                //reduce speed according to rules
                //this.speed().reset();
            }
        }
        return this;
    ...
    interact( sprite = null ){
        ...
        if( sprite instanceof Sprite){
            CollissionManager.check(sprite);
        }
        return this;
    }
    /**
